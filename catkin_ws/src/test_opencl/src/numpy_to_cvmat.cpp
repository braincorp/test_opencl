...
// NOTE: This file is copied from motor/motor/build/boost_python_utils/numpy_to_cvmat.h

#include <shining_utils/numpy_to_cvmat.h>
// The following (including the following comment) is taken from:
...
bool numpy_to_cvmat(const PyObject* o, Mat& m, const char* name, bool allowND)
{
